...
//            $type = Html::encode($docform->type);
//            $incoming_number = Html::encode($docform->incoming_number);
//            $incoming_date = Html::encode($docform->incoming_date);
//            $outgoing_date = Html::encode($docform->outgoing_date);
//            $outgoing_number = Html::encode($docform->outgoing_number);
//            $description = Html::encode($docform->description);
//            $sender = Html::encode($docform->sender);
//            $addresser = Html::encode($docform->addresser);
//           
